      ...
      <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
        ...
        >
          <p className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-6 leading-snug">
            Our work centres around three key objectives to accelerate the
          ...
          >
            <span className="">LEARN MORE ABOUT OUR WORK</span>
            <motion.span
              animate={{ x: [0, 5, 0] }}
        ...
        >
          {[
            ...
            >
              <p className="text-yellow-300 text-lg sm:text-xl font-bold mb-2">
                {card.title}
              </p>
